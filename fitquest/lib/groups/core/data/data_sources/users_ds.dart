...
import 'package:fitquest/groups/core/data/models/user_full_model.dart';
...
import 'package:fitquest/groups/features/login_and_registration/domain/entities/failures/email_already_exists_failure.dart';
...
class UsersDS {
  ...
  Future<void> updateFcmTokenForLoggedUser({String? fcmToken}) async {
    try {
      final uid = authDS.loggedUid;
      if (uid == null) {
        throw Exception('No logged-in user found');
      }

      // Use set with merge to create or update the document
      await _fullUserDataRef(uid).set(
