...
class ConversationItem extends StatelessWidget {
  ...
  const ConversationItem({required this.title,
    this.trailing,

    this.streak,
    this.isGroup = false,
    this.selected = false,
    this.removeConversationCallback,
    this.onTap, this.lastMessage,
    this.conversationId,
    this.uidForDirectConversation,
    this.typingUsers = const [], Key? key,}) : super(key: key);
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                  fontWeight: hasPendingMessages ? FontWeight.w700 : FontWeight.w600,
                                                  fontSize: 18,
                                                  color: Colors.white,
                                                ),
                                              ),
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 12,
                                                    fontWeight: hasPendingMessages ? FontWeight.w800 : FontWeight.w600,
                                                  ),
                                                ),
                                              ),
                                          ],
