...
import 'package:fitquest/groups/features/login_and_registration/presentation/screens/content/register_content.dart';
...
class LoginContent extends StatefulWidget implements LoginAndRegistrationContent  {
  ...
  @override
  String get title => "Sign in with Your Account";
...
class _LoginContentState extends State<LoginContent> {
  ...
  Future<void> loginSuccessfully(BuildContext context) async {
    ...
    Future.delayed(const Duration(milliseconds: 850), () {
      Navigator.of(context).pushNamedAndRemoveUntil(ScreenRoutes.home, (route) => false);
